%************************************************************************
%FILE:      saveJointNormalPlaneDistances.m
%AUTHOR:    Kosta Andoni (kosta.andoni@gmail.com)
%DATE:      4.12.2016
%PURPOSE:   Saves the joint normal plane distances into sections of the 
%           dataset
%************************************************************************
...
for i=1:section
   ...
   eval([strcat('joint_norm_plane_dists_', num2str(i), '= extractJointNormalPlaneDistances(joint_locs_now)')]);
   save(strcat('JointNormalPlaneDistances_',num2str(i,'%02d'),'_of_',num2str(section,'%02d'),'.mat'),strcat('joint_norm_plane_dists_',num2str(i)));
