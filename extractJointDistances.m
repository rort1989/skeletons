...
% 25 for kinect 2, 20 for kinect 1
...
N = nchoosek(num_joints,2);
for sequence = 1:size(joint_locs,1)
    joint_dists{sequence,1} = zeros(N,size(joint_locs{sequence,1},2)); %,'single'
