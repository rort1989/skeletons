%************************************************************************
%FILE:      saveJointNormalVelocities.m
%AUTHOR:    Kosta Andoni (kosta.andoni@gmail.com)
%DATE:      4.12.2016
%PURPOSE:   Saves the joint normal velocities into sections of the dataset
%************************************************************************
...
for i=1:section
   ...
   eval([strcat('joint_norm_vels_', num2str(i), '= extractJointNormalVelocities(joint_locs_now)')]);
   save(strcat('JointNormalVelocities_',num2str(i,'%02d'),'_of_',num2str(section,'%02d'),'.mat'),strcat('joint_norm_vels_',num2str(i)));
