%************************************************************************
%FILE:      saveJointMotions.m
%AUTHOR:    Kosta Andoni (kosta.andoni@gmail.com)
%DATE:      4.12.2016
%PURPOSE:   Saves the joint motions into sections of the dataset
%************************************************************************
...
for i=1:section
   ...
   eval([strcat('joint_motions_', num2str(i), '= extractJointMotions(joint_locs_now)')]);
   save(strcat('JointMotions_',num2str(i,'%02d'),'_of_',num2str(section,'%02d'),'.mat'),strcat('joint_motions_',num2str(i)));
