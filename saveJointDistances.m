...
for i=1:section
   ...
   eval([strcat('joint_dists_', num2str(i), '= extractJointDistances(joint_locs_now)')]);
   save(strcat('JointDistances_',num2str(i,'%02d'),'_of_',num2str(section,'%02d'),'.mat'),strcat('joint_dists_',num2str(i)));
