%************************************************************************
%FILE:      saveJointPlaneDistances.m
%AUTHOR:    Kosta Andoni (kosta.andoni@gmail.com)
%DATE:      4.12.2016
%PURPOSE:   Saves the joint plane distances into sections of the dataset
%************************************************************************
...
for i=1:section
   ...
   eval([strcat('joint_plane_dists_', num2str(i), '= extractJointPlaneDistances(joint_locs_now)')]);
   save(strcat('JointPlaneDistances_',num2str(i,'%02d'),'_of_',num2str(section,'%02d'),'.mat'),strcat('joint_plane_dists_',num2str(i)));
